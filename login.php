...
if(isset($_POST["email"])){
    ...
    $password = sanitizePost($_POST['password']);
     
    if(user_login($email, $password)=="true"){
        //check if it is a regular user account
        header("location: user_account.php");
        
    }else if(provider_login($email, $password)=="true"){
        //check if it is a service provider account
        header("location: service_provider_account.php");
    }else{
    $resp = "Email or Password not correct";
    }
